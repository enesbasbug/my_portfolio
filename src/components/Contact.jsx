    ...
    <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'> 
            <div className='pb-8'>
                ...
                <p className='py-6'>Submit the form below to get in touch with me. Cheers!</p>
            </div>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/842510ed-dc65-4c26-9e56-0bd59a3469b0" method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='text-white bg-gradient-to-b from-amber-500 to-amber-700 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's talk!</button>
                </form>
            </div>
