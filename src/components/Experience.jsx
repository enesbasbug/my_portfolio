...
const Experience = () => {
  ...
  return (
    <div name="experience" className='bg-gradient-to-b from-gray-800 to-black w-full h-screen pt-5'>
        <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
            ...
            <div className='w-full grid grid-cols-5 sm:grid-cols-5 gap-3 text-center py-8 px-12 sm:px-0'>
